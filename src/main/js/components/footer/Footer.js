                ...
                <Container className="align-content-center text-muted">
                    ...
                    <Row>
                        ...
                        <Col sm={10} className="align-justify-self-end">
                            ...
                            <p style={{textAlign: "justify"}}>LOTUS and Natural Products Online is an open-source open-data portal for natural products cheminformatics. Please submit bug reports, feature requests and general issues through <a target="_blank" rel="noopener noreferrer"  href="https://github.com/mSorok/NaturalProductsOnline/issues">the issues tracker at GitHub</a> or directly by mail to maria.sorokina[@]uni-jena.de.
                                LOTUS and Natural Products Online are developed by [put a link + city/country/institution here!] and maintained by the <a target="_blank" rel="noopener noreferrer"  href="https://cheminf.uni-jena.de">Steinbeck group</a> at the University Friedrich-Schiller in Jena, Germany.
