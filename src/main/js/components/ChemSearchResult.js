...
export default class ChemSearchResult extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            searchError: null,
    ...
    handleSDFDownload(e, npList) {
        ...
        download.setAttribute("download", "lotus_chemtype_search_result.sdf");
    ...
    fetchSearchResults(link="/api/search/chemclass?query="+ encodeURIComponent(this.props.match.params.q)) {
        restClient({
            method: "GET",
            path: link
        }).then(
